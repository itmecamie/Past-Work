...
// Citation: This program references chapters 1-6 of Deitel/Deitel - 11th edition
...
public class CamelliaYiMadLibs {
    ...
    public static void createMadLib(Scanner console) {
        ...
        File inputFile = promptForExistingFile(console, "What's the file name? ");
        ...
        System.out.print("What do you want to name the story? ");
